...
with SDK(
    ...
    res = sdk.features.create_feature(name="<value>", type_="metered", meter={
        "aggregation": {},
...
with SDK(
    ...
    res = sdk.features.query_feature()
...
with SDK(
    ...
    res = sdk.features.update_feature(id="<id>")
...
with SDK(
    ...
    res = sdk.features.delete_feature(id="<id>")
