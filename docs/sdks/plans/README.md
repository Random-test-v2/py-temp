...
with SDK(
    ...
    res = sdk.plans.create_plan(name="<value>")
...
with SDK(
    ...
    res = sdk.plans.update_plan(id="<id>")
...
with SDK(
    ...
    res = sdk.plans.delete_plan(id="<id>")
...
with SDK(
    ...
    res = sdk.plans.sync_plan_prices(id="<id>")
