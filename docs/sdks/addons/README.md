...
with SDK(
    ...
    res = sdk.addons.get_addon_by_lookup_key(lookup_key="<value>")
...
with SDK(
    ...
    res = sdk.addons.get_addon(id="<id>")
...
with SDK(
    ...
    res = sdk.addons.update_addon(id="<id>")
...
with SDK(
    ...
    res = sdk.addons.delete_addon(id="<id>")
