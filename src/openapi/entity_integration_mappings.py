...
class EntityIntegrationMappings(BaseSDK):
    def create_entity_integration_mapping(
        self,
        *,
        entity_id: str,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="createEntityIntegrationMapping",
                oauth2_scopes=None,
    ...
    async def create_entity_integration_mapping_async(
        self,
        *,
        entity_id: str,
        entity_type: models.TypesIntegrationEntityType,
    ...
    def delete_entity_integration_mapping(
        self,
        *,
        id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="deleteEntityIntegrationMapping",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def delete_entity_integration_mapping_async(
        self,
        *,
        id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
