...
class Webhooks(BaseSDK):
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="handleChargebeeWebhook",
                oauth2_scopes=None,
    ...
    async def handle_chargebee_webhook_async(
        self,
        *,
        tenant_id: str,
        environment_id: str,
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="handleHubspotWebhook",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def handle_hubspot_webhook_async(
        self,
        *,
        tenant_id: str,
        environment_id: str,
    ...
    def handle_moyasar_webhook(
        self,
        *,
        tenant_id: str,
        environment_id: str,
        x_moyasar_signature: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Dict[str, Any]:
        r"""Handle Moyasar webhook events

        Use as the Moyasar webhook endpoint URL. Receives payment events from Moyasar to update payment status in FlexPrice.

        :param tenant_id: Tenant ID
        :param environment_id: Environment ID
        :param x_moyasar_signature: Moyasar webhook signature
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        req = self._build_request(
            method="POST",
            path="/webhooks/moyasar/{tenant_id}/{environment_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="handleMoyasarWebhook",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def handle_moyasar_webhook_async(
        self,
        *,
        tenant_id: str,
        environment_id: str,
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="handleNomodWebhook",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def handle_nomod_webhook_async(
        self,
        *,
        tenant_id: str,
        environment_id: str,
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="handleQuickbooksWebhook",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def handle_quickbooks_webhook_async(
        self,
        *,
        tenant_id: str,
        environment_id: str,
    ...
    async def handle_razorpay_webhook_async(
        self,
        *,
        tenant_id: str,
        environment_id: str,
    ...
    async def handle_stripe_webhook_async(
        self,
        *,
        tenant_id: str,
        environment_id: str,
