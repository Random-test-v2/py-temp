...
class Workflows(BaseSDK):
    def query_workflow(
        ...
        *,
        ...
        :param end_time:
        :param entity: e.g. plan, invoice, subscription
        :param entity_id: e.g. plan_01ABC123
        :param expand:
        :param filters: filters allows complex filtering based on multiple fields (same as FeatureFilter)
        :param limit:
        :param offset:
        :param order:
        :param sort:
        ...
        :param status:
        :param task_queue:
        :param workflow_id: Workflow-specific filters
        :param workflow_status: e.g. Running, Completed, Failed
        :param workflow_type:
