...
class DtoCreateSubscriptionRequestTypedDict(TypedDict):
    ...
    line_items: NotRequired[List[DtoCreateSubscriptionLineItemRequestTypedDict]]
    ...
    payment_terms: NotRequired[TypesPaymentTerms]
...
class DtoCreateSubscriptionRequest(BaseModel):
    ...
    line_items: Optional[List[DtoCreateSubscriptionLineItemRequest]] = None
    r"""LineItems are extra line items to add at creation (each with price_id or price), in addition to plan prices"""
    ...
    payment_terms: Optional[TypesPaymentTerms] = None
